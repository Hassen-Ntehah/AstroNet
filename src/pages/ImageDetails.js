        ...
        <Container className="py-8 md:py-12 px-4 md:px-8 lg:px-16">
          ...
          <Row className="justify-content-center">
            <Col lg={10}>
              ...
              <div className="bg-panel/30 backdrop-blur-lg rounded-2xl p-4 sm:p-6 md:p-8 border border-cyan/10">
                <h1 
                ...
                <div className="flex flex-wrap gap-2 sm:gap-3 mb-4 md:mb-6">
                  <span className="inline-block px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-cyan/20 border border-cyan/40">
                    <span className="text-cyan font-semibold text-xs sm:text-sm">{details.date}</span>
                  </span>
                  {details.copyright && (
                    <span className="inline-block px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-panel/50 border border-white/20">
                      <span className="text-white font-semibold text-xs sm:text-sm">© {details.copyright}</span>
                    </span>
                  )}
                </div>
                
                <p className="text-base sm:text-lg md:text-xl text-white leading-relaxed mb-4 md:mb-6 text-justify">
                  {details.explanation}
                </p>
                ...
                {details.hdurl && (
                  <a 
                    ...
                    className="inline-block px-4 py-2 sm:px-6 sm:py-3 rounded-full text-white text-sm sm:text-base font-semibold transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl"
                    style={{
                      background: 'linear-gradient(90deg, #455B9A, #5691B9)',
                      boxShadow: '0 10px 25px rgba(86, 145, 185, 0.4)',
                    }}
