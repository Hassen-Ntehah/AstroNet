...
import logo from "../images/logoWithTitle-removebg-preview.png";
export default function Footer() {
  return (
    
    <footer class="bg-neutral-primary-soft">
         <div className="relative z-10 text-center underline">
          {/* <h4
            className="absolute -top-0 left-1/2 text-lg mb-3"
            style={{
              color:"#ffffff"
            }}
          >
    ...
    {/* <div className="flex justify-center">
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-body sm:text-center">© 2025 <a href="https://flowbite.com/" class="hover:underline">AstroNet</a>. All Rights Reserved.
          </span>
